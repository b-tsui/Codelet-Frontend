...
const CardQuiz = ({ cards }) => {
  ...
  return (
    <div className="card-quiz-container">
      <div className="game-description-quiz">
        Select the correct term for the displayed definition! If you are
        correct, the definition will flash green, otherwise it will flash red.
      </div>
      <div className="card-quiz-definition">
        <Card
          className={(classes.root, "card-quiz-definition")}
          id="card-quiz-definition"
          variant="outlined"
        >
          <CardContent>
      ...
      <div className="card-quiz-terms-container">
        <List
          component="nav"
          aria-label="quiz answers list"
          className="card-quiz-terms-container"
        >
          {terms.map((term) => (
            <ListItem
              button
              id={term}
              className={"card-quiz-term"}
              onClick={checkAnswer}
            >
              {term}
            </ListItem>
